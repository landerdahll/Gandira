...
export default function OrganizationMembersPage() {
  const { active, canViewMembers, canManageMembers, canManageInvitations } = useOrganization();
...
const inviteCard: React.CSSProperties = { display: 'grid', gridTemplateColumns: '2fr 1fr', gap: 14, padding: 18, marginTop: 20, background: 'var(--theme-surface)', border: '1px solid var(--theme-border)', borderRadius: 14 };
