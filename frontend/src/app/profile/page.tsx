...
import { formatClubDiscountPercentage, shouldShowClubMembershipCard } from '@/lib/club-membership';
import toast from 'react-hot-toast';
import { Mail, Phone, Calendar, PersonStanding, Eye, EyeOff, Pencil, X, Lock, UserRound, Camera, BadgePercent, CheckCircle2, TicketCheck } from 'lucide-react';
      ...
      {modal === 'email' && (
        <EditFieldModal
          ...
          onSave={async value => {
            ...
            setProfile((await usersApi.getProfile()).data);
