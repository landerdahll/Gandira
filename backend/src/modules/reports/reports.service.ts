...
export class ReportsService {
  ...
  async getEventReport(eventId: string, _producerId: string) {
    ...
    const [ticketStats, revenueData, checkInCount, batchBreakdown, genderData, buyerBirthDates, couponBreakdown] =
      await Promise.all([
        ...
        // Revenue from paid orders (total already has discounts deducted)
        ...
        // Cupons utilizados neste evento
